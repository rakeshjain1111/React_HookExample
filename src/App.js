...
function App() {
  ...
  return (
    <div style={{background:bgcolor}}>
      ...
      <input type='range' name='range' step={5} onChange={getValue}/><br/>
      <label>Change Text Color:</label>
      <input type='color' name='color' onChange={getColor} />
      <hr/>
      
      <h1 style={{textAlign:'center'}}>Change BG Color </h1>
      <div style={{alignItems:'center',display:'flex', justifyContent:'space-evenly'}}>
         ...
         <span>Select BG Corrul</span> <input type='color' onChange={BgColor}/>
      </div>
      <hr/>
      <div>
        <h1 style={{textAlign:'center'}}>Change BG Color </h1>
